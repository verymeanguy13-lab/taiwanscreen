// app/api/admin/test-institutional-ingest/route.ts
// TEMPORARY — isolated test for the batched ingestInstitutionalFlows rewrite.
...
export async function POST(req: NextRequest) {
  ...
  const result = await ingestInstitutionalFlows(taiwanDate);
